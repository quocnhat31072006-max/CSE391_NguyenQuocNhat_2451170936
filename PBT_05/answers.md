...
- Sidebar hiện đầy đủ
- Grid video khoảng 4-6 cột
- Header hiển thị đầy đủ search bar + buttons
- Font size lớn và spacing rộng hơn

---

Media Queries tìm thấy trong DevTools:
...
- Mobile ưu tiên tiết kiệm không gian
- Desktop ưu tiên hiển thị nhiều content
- Layout responsive chủ yếu dùng:
  - Flexbox
  - CSS Grid
  - Media Queries
